ایده‌هایی که این کدگذاری‌ها بر اساس آن‌ها هستند به هیچ وجه جدید نیستند. به عنوان مثال، آن‌ها اشتراکات زیادی با ASN.1 دارند، یک زبان تعریف طرح‌واره که اولین بار در سال 1984 استاندارد شد
